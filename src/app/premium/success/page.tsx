  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      <div className="max-w-md">
        <div className="w-16 h-16 mx-auto mb-8 rounded-full bg-sage-100 flex items-center justify-center">
        ...
        <p className="text-gray-500 font-light leading-relaxed mb-4">
          Ya puedes seguir conversando con Buda sin límites en WhatsApp.
        </p>

        <p className="text-sm text-gray-400 mb-10">
          Para cancelar tu suscripción en cualquier momento, escribe &ldquo;cancelar premium&rdquo; a Buda en WhatsApp.
        </p>
